  ...
  const PlayingMusic = music.map((musicData, index) =>
    <div className="p-5 rounded-0 MainBox">
      <div className="container-fluid py-2 shadow-lg p-2 mb-5">
        <img src={'http://127.0.0.1:8000' + musicData.PhotoCover} /*src="https://images.pexels.com/photos/12468153/pexels-photo-12468153.jpeg?cs=srgb&dl=pexels-fernando-paleta-12468153.jpg&fm=jpg" className="img-fluid"*/ alt="..."/>
      </div>
